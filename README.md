...
## Install
First, cd into the `player-backend` directory and rename `.env.example` to `.env`. Change the database credentials in the new `.env` file to match your newly imported database.
